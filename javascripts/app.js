...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("  <a href=\"http://www.nflabs.com\" target=\"blank\">NFLabs</a> / All rights reserved.</p>\n                        </div>\n\n                    </div>\n                </div>\n            </section>\n            <!-- End footer -->\n        </div>");
  return buffer;
