...
$(window).load(function() {
   ...
   if ($('.scrollMenu').length) {
      ...
      if (isMobile === false && ($('#paralaxSlice1').length || isMobile === false && $('#paralaxSlice2').length) || isMobile === false && $('#paralaxSlice5').length)
      {
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<!-- Primary Page Layout\n================================================== -->\n<!-- globalWrapper -->\n<div id=\"globalWrapper\" class=\"localscroll\">\n    <!-- content -->\n\n    <!-- END How it works -->\n    <div id=\"paralaxSlice6\" data-stellar-background-ratio=\"0.5\">\n    <div class=\"maskParent\">\n        <div class=\"paralaxMask2\"></div>\n        <div class=\"paralaxText container\">\n            <div class=\"row\">\n                <div class=\"col-xs-12\">\n                    <h1 style=\"font-weight:500;font-size:60px;\">Careers at NFLabs</h1><br/>\n                    <h2 class=\"subTitle\" style=\"margin-bottom:40px;\">We simplify big data so everyone can benefit from it. Want to help?</h2>\n                </div>\n            </div>\n        </div>\n    </div>\n    </div>\n    <!-- about us -->\n    <section class=\"slice noPaddingBottom\" id=\"whatwedo\">\n        <div class=\"container\">\n            <div class=\"row\">\n                <div class=\"col-xs-12\">\n                    <h1>What We Do</h1>\n                    <h2 class=\"subTitle\">Our mission is to simplify the way the world analyzes data</h2>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div class=\"col-m-8\">\n                    <h2 style=\"color: #222;font-size:34px;line-height:34px;text-align:center;\">Challenges</h2>\n\n                    <h2 class=\"subTitle h2nobg\" style=\"margin-bottom:20px;font-size:20px;text-align:left;line-height:24px;\">We are running production services based on Hadoop since 2009, from the early days of Hadoop and BigData. Our team have experience of runing 1PB cluster with over 1TB of log processing a day for the last 4 years, we'v done data analytics for various services, optimized analytics algorithms to speed it up by 100x, all in production.</h2>\n                    <h2 class=\"subTitle h2nobg\" style=\"font-size:20px;text-align:left;line-height:24px;\"> We are now transforming our experience and knowledge into solution and service through very advanced analytic features and with the help of the best people. We are exending data analysis by making it super easy, so anyone can benefit from it, not only Ph.D data scientists.</h2>\n                </div>\n\n                <div class=\"col-m-8 endofsection\">\n                    <h2 style=\"color: #222;font-size:34px;text-align:center;line-height:34px;\">Technologies</h2>\n                    <h2 class=\"subTitle h2nobg\" style=\"margin-bottom:20px;font-size:20px;text-align:left;line-height:24px;\">Day to day our work involves working with all kind of technologies: Hadoop, Spark, Elasticsearch, Hbase, Hive, Kafka, Docker, Puppet, d3.js, AngularJS, Ember, etc. <br />\n                        We also employ internal made technologies like online programmable filesystem, global load balancer, general data processing pipeline or data exploration tools. <br /></h2>\n                    <h2 class=\"subTitle h2nobg\" style=\"margin-bottom:20px;font-size:20px;text-align:left;line-height:24px;\">We truly love Open Source and are not only using it but also contributing. Here is a short list of our contributions:<br /></h2>\n                    <p class=\"opensource\" style=\"text-align:center;font-weight:bold;font-size:22px;\"><a style=\"text-decoration: none;\" href=\"http://zeppelin-project.org/\">Zeppelin</a>, <a style=\"text-decoration: none;\" href=\"http://grok.nflabs.com/\">Java-Grok</a>, <a style=\"text-decoration: none;\" href=\"http://mrql.incubator.apache.org/\">Apache MRQL</a></p> <br />\n                    <h2 style=\"color: #888;font-size:30px;line-height:30px;text-align:center;margin-bottom:40px;margin-top:20px;\">Join us and add more!</h2><br/>\n                </div>\n            </div>\n        </div>\n    </section>\n    <!-- about us -->\n    <!-- How it works -->\n    <section class=\"slice noPaddingBottom color4\" id=\"aboutus\">\n        <div class=\"container\">\n            <div class=\"row\">\n                <div class=\"col-xs-12\" style=\"text-align:center;\">\n                    <h1 style=\"display:inline-block;margin-right:15px;\">Who We Are</h1>\n                    <h2 class=\"subTitle\">A small international team</h2>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div class=\"col-m-8\">\n                    <h2 style=\"color: #222;font-size:34px;line-height:34px;text-align:center;color:white;margin-bottom:25px;\">Our Team</h2>\n\n                    <h2 class=\"subTitle h2nobg\" style=\"margin-bottom:25px;font-size:20px;text-align:left;line-height:24px;\">Like Skunkworks, we keep our engineering team small with given high degree of autonomy, flexible hours and no bureaucracy.</h2>\n                    <h2 class=\"subTitle h2nobg\" style=\"margin-bottom:25px;font-size:20px;text-align:left;line-height:24px;\"> The team balance practical work and an advanced research. We enjoy challenges, new ideas, fast prototyping and deploying results to production quickly.</h2>\n                    <h2 class=\"subTitle h2nobg\" style=\"margin-bottom:80px;font-size:20px;text-align:left;line-height:24px;\"></h2>\n                </div>\n            </div>\n        </div>\n    </section>\n\n</section>\n\n    <!-- Client -->\n    <section class=\"slice\" id=\"joboffers\">\n        <div class=\"container\">\n        <h1 style=\"margin-bottom:40px;\">Job Vacancies</h1><br>\n           <div class=\"row\" style=\"margin-bottom: 20px;\">\n               <div class=\"col-md-6 resourcescontainer\">\n                  <div class=\"pricingBloc focusPlan\">\n                     <h3><font size=\"6\">Software Engineer</font>\n                       <span>Data analytics platform</span>\n                     </h3>\n                     <div class=\"responsabilities\">\n                         <h1>Responsibilities</h1>\n                         <ul>\n                              <li>Smart and self organized team player</li>\n                              <li>Take part in planning, coding, testing and code reviews</li>\n                              <li>Writing code in variety of languages, primarily using Java.</li>\n                        </ul>\n                     </div>\n                     <div class=\"requirements\">\n                         <h1>Requirements</h1>\n                         <ul>\n                            <li>Strong engineering skills: love for programming and problem solving</li>\n                            <li>Deep understanding in Computer Science and Operating Systems</li>\n                            <li>Understanding of distributed computing / parallel processing</li>\n                            <li>Willing to communicate in English</li>\n                            <li>Familiar with Opensource process and ecosystem</li>\n                         </ul>\n                     </div>\n              <div class=\"requirements\">\n                          <h1>Nice to have</h1>\n              <ul>\n                           <li>Involvement in Opensource projects</li>\n                           <li>Experience in data analytics and machine learning</li>\n              </ul>\n                     </div>\n                  </div>\n               </div>\n               <div class=\"col-md-6 resourcescontainer\">\n                  <div class=\"pricingBloc focusPlan\">\n                     <h3><font size=\"6\">Software Engineer</font>\n                        <span>DevOps</span>\n                     </h3>\n                     <div class=\"responsabilities\">\n                         <h1>Responsibilities</h1>\n                         <ul>\n                           <li>Self organized work</li>\n                           <li>Identify and drive automation for the services</li>\n                           <li>Adopt new technology for a service</li>\n                        </ul>\n                     </div>\n                     <div class=\"requirements\">\n                         <h1>Requirements</h1>\n                         <ul>\n                            <li>Experience in building high-performance, reliable services</li>\n                            <li>Keep fault tolerance in mind</li>\n                            <li>Love logs and admin work but have strong ability to code\\automate things</li>\n                            <li>Familiar with existing automation tools: python, ansible, chief\\puppet</li>\n                            <li>Willing to communicate in English</li>\n                        </ul>\n                     </div>\n             <div class=\"requirements\">\n                   <h1>Nice to have</h1>\n              <ul>\n                            <li>Involvement in Opensource projects</li>\n                            <li>Hadoop eco-system experience</li>\n              </ul>\n             </div>\n                  </div>\n               </div>\n            </div>\n            <h4>* 병역특례(전문연구요원) available</h4>\n            <h2 style=\"text-align:center;margin-top:15px;\">Send your application to <span style=\"color: black;\">info@nflabs.com<span></h2>\n    </div>\n\n</section>\n<!-- END Client -->\n\n            <!-- content -->\n            <!-- footer -->\n            <footer class=\"color4\">\n                <section id=\"mainFooter\">\n                    <div class=\"container\" id=\"footer\">\n                        <div class=\"row\">\n                            <div class=\"col-sm-4\">\n                            </div>\n                            <div class=\"col-sm-4\">\n                                <div class=\"footerWidget\">\n                                    <h4>NFLabs</h4>\n                                    <address>\n                                        <p> <i class=\"icon-location\"></i>&nbsp;34, Hakdong-ro 30-gil 2nd Floor,<br>\n                                            Gangnam-gu, Seoul South Korea <br>\n                                            <i class=\"icon-phone\"></i>&nbsp;+82(0)2-3458-9600 <br>\n                                            <i class=\"icon-mail-alt\"></i>&nbsp;<a href=\"mailto:info@nflabs.com\">info@nflabs.com</a>\n                                        </p>\n                                    </address>\n                                </div>\n                            </div>\n\n                            <div class=\"col-sm-4\">\n                                <div class=\"footerWidget\">\n                                    <h4>We're social</h4>\n                                    <ul class=\"socialNetwork pull-right\">\n                                        <li><a href=\"https://www.facebook.com/pages/NFLabs/254269554635823\" class=\"tips\" title=\"\" target=\"_blank\" data-original-title=\"follow us on Facebook\"><i class=\"fa fa-facebook iconRounded\"></i></a></li>\n                                        <li><a href=\"https://twitter.com/koreabigdata\" class=\"tips\" title=\"\" data-original-title=\"follow us on Twitter\" target=\"_blank\"><i class=\"fa fa-twitter iconRounded\"></i></a></li>\n                                        <li><a href=\"https://github.com/NFLabs\" class=\"tips\" title=\"\" data-original-title=\"Github\" target=\"_blank\"><i class=\"fa fa-github-alt iconRounded\"></i></a></li>\n                                    </ul>\n                                </div>\n                            </div>\n        </div>\n    </div>\n</section>\n</footer>\n<!-- End footer -->\n</div>\n\n<!-- GA -->\n<script>\n  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){\n  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),\n  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)\n  })(window,document,'script','//www.google-analytics.com/analytics.js','ga');\n\n  ga('create', 'UA-38575365-1', 'auto');\n  ga('send', 'pageview', {\n    'page' : '/jobs',\n    'title' : 'jobs'\n  });\n\n</script>\n");
